        ...
        <div className='flex min-h-full bg-white dark:bg-slate-900 '>
            <div className='flex w-full flex-col'>
                ...
                <div className='overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem] '>
                    <div className='py-16 sm:px-2 lg:relative lg:px-0 lg:py-20 min-h-screen gridDark flex flex-col items-center p-6'>
                        ...
                        <div className='mx-auto mb-20  grid max-w-7xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4  lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12'>
                            <div className="relative z-10 md:text-center lg:text-left">
                                ...
                                <div className="relative">
                                    <p className="inline bg-gradient-to-r from-pink-300 via-sky-100 to-pink-500 bg-clip-text font-display text-5xl tracking-tight text-transparent">About Me</p>
