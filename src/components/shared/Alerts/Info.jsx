...
<div className="my-8 flex rounded-3xl p-6 bg-sky-50 dark:bg-slate-800/60 dark:ring-1 dark:ring-slate-300/10">
    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none"
        ...
        <defs>
            <radialGradient cx={0} cy={0} r={1} gradientUnits="userSpaceOnUse" id=":S6:-gradient"
                gradientTransform="matrix(0 21 -21 0 20 11)">
                <stop stopColor="#0EA5E9" />
                <stop stopColor="#22D3EE" offset=".527" />
                <stop stopColor="#818CF8" offset={1} />
            </radialGradient>
            <radialGradient cx={0} cy={0} r={1} gradientUnits="userSpaceOnUse" id=":S6:-gradient-dark"
        ...
        <g className="dark:hidden">
            ...
            <path fillRule="evenodd" clipRule="evenodd"
                ...
                className="fill-[var(--icon-background)]" fillOpacity="0.5" />
            <path
    ...
    <div className="ml-4 flex-auto">
        <p className="m-0 font-display text-xl text-sky-900 dark:text-sky-400">{title}</p>
        <div
            className="prose mt-2.5 text-sky-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-sky-900 prose-code:text-sky-900 dark:text-slate-300 dark:prose-code:text-slate-300">
            {children}
        </div>
    </div>
</div>
